...
//        insStat1.setText(stats.getRoundsPlayed());
//
//        TextView insStat2 = (TextView) findViewById(R.id.actualStat2);
//        insStat2.setText((int) stats.getAvgPointsPerRound());
//
//        TextView insStat3 = (TextView) findViewById(R.id.actualStat3);
//        insStat3.setText((int) stats.getTotalPoints());
//
//        TextView insStat4 = (TextView) findViewById(R.id.actualStat4);
//        insStat4.setText((int) stats.getCorrectGuessAvg());
    }
    @Override
